...
def initialize_model():
    ...
    try:
        ...
        training_data = [
            ...
            "<USER>はじめまして<ASSISTANT>はじめまして。私は量子ビットニューラルネットワークを使った人工知能、ニューロQです。",
            "<USER>ありがとう<ASSISTANT>どういたしまして。お役に立てて嬉しいです。",

            # 量子コンピュータ
            "<USER>量子コンピュータについて教えて<ASSISTANT>量子コンピュータは量子力学の原理を利用した次世代の計算機です。従来のコンピュータでは解けない複雑な問題を高速に解くことができます。",
            "<USER>量子ビットとは<ASSISTANT>量子ビットは0と1の重ね合わせ状態を取ることができる量子情報の単位です。",
            "<USER>量子もつれとは<ASSISTANT>量子もつれは二つ以上の粒子が相関を持ち、一方の状態が他方に影響を与える現象です。",
            ...
            # 人工知能
            "<USER>人工知能とは<ASSISTANT>人工知能は人間の知能を模倣するコンピュータシステムです。学習、推論、問題解決などの能力を持っています。",
            "<USER>機械学習とは<ASSISTANT>機械学習はデータからパターンを学習するAIの技術です。経験から学習し、性能を向上させます。",
            "<USER>ディープラーニングとは<ASSISTANT>ディープラーニングは多層のニューラルネットワークを使った機械学習の手法です。画像認識や自然言語処理で優れた性能を発揮します。",
            ...
            # ニューラルネットワーク
            "<USER>ニューラルネットワークとは<ASSISTANT>ニューラルネットワークは人間の脳の神経回路を模倣した計算モデルです。多数のニューロンが層状に接続され、データから特徴を学習します。",
            ...
            # プログラミング
            "<USER>Pythonとは<ASSISTANT>Pythonは人工知能開発で最も人気のあるプログラミング言語です。シンプルで読みやすい文法が特徴です。",
            ...
            # 一般的な質問応答
            "<USER>これは何ですか<ASSISTANT>詳しく教えていただけますか？具体的に何について知りたいですか？",
            "<USER>どうやって動くの<ASSISTANT>仕組みについてご説明します。具体的にどの部分について知りたいですか？",
            "<USER>わかりません<ASSISTANT>大丈夫です。もう少し詳しく説明しますね。どの部分がわかりにくいですか？",
        ]

        # データを増やして学習を安定化
        training_data = training_data * 15

        model.train(training_data, epochs=10, seq_len=128)
